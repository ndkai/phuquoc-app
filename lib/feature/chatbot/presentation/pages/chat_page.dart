...
import 'package:phuquoc/feature/chatbot/presentation/widgets/chat_ui/flutter_chat_ui.dart';
import 'package:phuquoc/feature/chatbot/presentation/widgets/chat_ui/src/widgets/chat.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    return BaseSubPage(
      ...
      child: BlocProvider<ChatBotBloc>(
          ...
          listener: (context, state){
              ...
              if(state is ChatBotLoading){
                ...
                if(state is ChatBotError){
                  ...
                  types.PartialText message = types.PartialText(text: "Xin lỗi, hiện tại tôi không trả lời được!");
                  _receive(message);
                } else
                if(state is PostQuestionLoaded){
                  _deleteMessage(loadingMessageID);
                  for(var i in state.response.chatResponces!){
                    if(i.image != null){
