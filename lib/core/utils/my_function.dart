...
import 'package:phuquoc/feature/base/page/loading_page.dart';
...
void showLoadingPage(BuildContext context){
  changePage(context, AppLoadingPage());
}

void showLoadingPageReplace(BuildContext context){
  changePageWithReplacement(context, AppLoadingPage());
}
